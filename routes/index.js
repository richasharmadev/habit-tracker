...
// User & Habit schema module
const User = require('../models/User');
const Habit = require('../models/Habit');

// Homepage on first apperance
...
// Returning date in string format
function getDate(n) {
    let d = new Date();
...
// Handling Daily & Weekly view toggle
...
// Post method to add habits to mongodb database
router.post('/dashboard', (req, res) => {
    const { content } = req.body;

    Habit.findOne({ content: content, email: email }).then(habit => {
        if (habit) {
            // Letting user update existing habit
...
// Deleting a habit using get method
